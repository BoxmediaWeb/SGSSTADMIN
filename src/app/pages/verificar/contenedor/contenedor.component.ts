...
export class ContenedorComponent implements OnInit {
  ...
  */
  ...
  irDocumento(ubicacion) {
    this._router.navigate([`/sgsst/verificar/indice/${this.ref_estandar}/documento/${ubicacion}`]);
  }

  irArchivos() {
    this._router.navigate([`/sgsst/verificar/indice/${this.ref_estandar}/archivos`]);
  }
