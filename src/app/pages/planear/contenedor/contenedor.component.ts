...
export class ContenedorComponent implements OnInit {
  ...
  constructor(
    ...
    this._router.events.pipe(
      ...
      console.log("Este es el evento cargado =>", event);
    });
  ...
  */
  ...
  getMaestroDocumento2(){
    ...
    subscribe((response) => {
      ...
      console.log("Maestros 2=>",response.data.maestroDocumento);
     });
  }
  ...
  irDocumento(ubicacion) {
    this._router.navigate([`/sgsst/planear/indice/${this.ref_estandar}/documento/${ubicacion}`]);
  }

  irArchivos() {
    this._router.navigate([`/sgsst/planear/indice/${this.ref_estandar}/archivos`]);
  }
  ...
  ngOnInit(): void {
    ...
    console.log("Este es el nombre del estandar =>", this.nombre_estandar);
  }
