...
export class ContenedorComponent implements OnInit {
  ...
  */
     ...
     irFormato(){
      this._router.navigate([`/sgsst/actuar/indice/${this.ref_estandar}/formulario/formularioestandar`]);
     }
  ...
  */
  ...
  irDocumento(ubicacion) {
    this._router.navigate([`/sgsst/actuar/indice/${this.ref_estandar}/documento/${ubicacion}`]);
  }

  irEditMaestro(ubicacion) {
    this._router.navigate([`/sgsst/actuar/indice/${this.ref_estandar}/editmaestro/${ubicacion}`]);
  }

  irArchivos() {
    this._router.navigate([`/sgsst/actuar/indice/${this.ref_estandar}/archivos`]);
  }
